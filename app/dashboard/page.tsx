        ...
        <section className="flex justify-between gap-10 rounded-2xl">
          ...
          <div className="flex gap-5 w-1/2">
            <div className="flex flex-col gap-5 w-full text-center">
              <StatsCard title="All tips amount" value="13 092" />
              <StatsCard title="Showed messages" value="13 078" />
            </div>
            <div className="flex flex-col gap-5 w-full text-center">
              <StatsCard title="Tips today" value="92" />
              <StatsCard title="Handled tokens by you" value="12" />
            </div>
          </div>
        </section>
        <TransactionList />
